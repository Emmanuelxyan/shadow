...
module.exports = {
    VERSION: '❰🐼🧭sʜᴀᴅᴏᴡʙᴏᴛ🧭🐼❱- Public Stable',
    ...
    CAPTION: process.env.CAPTION === undefined ? ' ❰🐼🧭sʜᴀᴅᴏᴡʙᴏᴛ🧭🐼❱ ' : process.env.CAPTION,
    ...
    GROUPN1: process.env.GROUP_NAME_1 === undefined ? 'sʜᴀᴅᴏᴡʙᴏᴛ OFFICIAL SUPPORT': process.env.GROUP_NAME_1,
    GROUPL1: process.env.GROUP_LINK_1 === undefined ? 'https://chat.whatsapp.com/Ej9CCj2PUSoKhkoc0mbBTR': process.env.GROUP_LINK_1,
    GROUPN2: process.env.GROUP_NAME_2 === undefined ? ' sʜᴀᴅᴏᴡʙᴏᴛ OFFICIAL TEST': process.env.GROUP_NAME_2,
