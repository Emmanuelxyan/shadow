...
if (config.LANG == 'EN') {
    conn.on('open', async () => {
        ...
        if (config.WORKTYPE == 'public') {
                ...
                if (conn.user.jid === '@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱ started in Private Mode 🍁➢*\n\n_Please do not try any commands here. This is your log number._\n_You can try commands anywhere else :)_\n\n_Type_ *.trex* _to get your full command list._\n\n_Your bot in Private Mode. To change, use_ ```.public``` _command._\n\n🍁 Developer : Ginger\n\n Please subscribe our youtube channel\n\nhttps://youtube.com/channel/UCIKjhk7X4vOQWbeY9oTD7oQ\n\nHow to make T-Rex bot 👿\n\nhttps://youtu.be/oaSPHc78LNQ\n\nHow to make heroku account 👿\n\nhttps://youtu.be/fvKNJlfrfuI\n\nHow to fix bot errors 👿\n\nhttps://youtu.be/VuXI3smjsNc\n\nJoin with us Share our bot and help us 🤭😘👿\n\n *Thank you for using ❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱*', MessageType.text);
    ...
    conn.on('open', async () => {
        ...
        if (config.WORKTYPE == 'public') {
                ...
                await conn.sendMessage(conn.user.jid, '*❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱ private ආකාරයට ක්‍රියාකිරිම ආරම්භ විය.🍁➢*\n\n_කරුණාකර මෙහි command උත්සාහ නොකරන්න. මෙය ඔබගේ ලොග් අංකයයි._\n_ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය :)_\n\n_ඔබේ command list එක ලබාගැනීමට_ *.trex* _command එක භාවිතා කරන්න._\n\n_ඔබේ bot private ක්‍රියාත්මක වේ. වෙනස් කිරීමට_ ```.public``` _විධානය භාවිතා කරන්න._\n\n🍁 Developer : Ginger\n\n Please subscribe our youtube channel\n\nhttps://youtube.com/channel/UCIKjhk7X4vOQWbeY9oTD7oQ\n\nHow to make T-Rex bot 👿\n\nhttps://youtu.be/oaSPHc78LNQ\n\nHow to make heroku account 👿\n\nhttps://youtu.be/fvKNJlfrfuI\n\nHow to fix bot errors 👿\n\nhttps://youtu.be/VuXI3smjsNc\n\nJoin with us Share our bot and help up 🤭😘👿\n\n *❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱ භාවිතා කිරීම ගැන ස්තූතියි .*', MessageType.text);
                }
            }
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI') {
                                await conn.sendMessage(conn.user.jid, '*-- දෝෂ වාර්තාව [❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱] --*' + 
                                    '\n\n*❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱ Bot දෝෂයක් සිදුවී ඇත!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱] ⚜️*' + 
                                        '\n==== ```දෝෂ නිරාකරණය කර ඇත!``` ====' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱] --*' + 
                                    '\n\n*❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱ an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚜️ ERROR ANALYSIS [❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱] ⚜️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚜️ ERROR ANALYSIS [❰🐼⌚sʜᴀᴅᴏᴡʙᴏᴛ⌚🐼❱I] ⚜️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
